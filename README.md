...
Or via downloading a [zip](https://github.com/xguse/prep-data-for-ibd-portal/archive/master.zip) of the repository via the project's [github page](https://github.com/xguse/prep-data-for-ibd-portal).
